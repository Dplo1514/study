...
public class programmers_cloth_03 {
    /*
     * Q
    ...
    static class Solution {
        public static int solution(String[][] clothes) {
            // DESC : clothes의 i번째는 원소 , j번째는 맵 [ {"얼굴" : "스모키"} , {"바지" , "청바지"} , {"바지" , "슬렉스"} ]
            // 1. hashing 진행
    ...
    public static void main(String[] args) {
        int answer = Solution.solution(new String[][] {{"yellow_hat", "headgear"}, {"blue_sunglasses", "eyewear"}, {"green_turban", "headgear"} , {"snapBack", "headgear"}});
        System.out.println("answer = " + answer); // expect : 2
    }
}
